            ...
            Future.delayed(const Duration(milliseconds: 100), () {
              Navigator.pushNamed(
                ...
                arguments: ResetPasswordArgs(
                  email: _verificationEmail,
                  otp: state.otp ?? '',
                  primaryColor: ColorManger.green,
                  backgroundColor: ColorManger.mintyLightGreen,
                  successRoute: RouteManger.adminAuth,
                  title: appLocalization.admin_reset_password_title,
                  subtitle: appLocalization.admin_reset_password_subtitle,
                ),
              );
            });
          }
                ...
                builder: (context, state) {
                  if (state is AuthLoadingState) {
                    return CustomLoadingWidget(
                      indicatorColor: ColorManger.green,
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: ColorManger.green, // 👈 keep admin green
                              ...
                              Center(
                                child: TextButton(
                                  ...
                                  child: Text(
                                    ...
                                    style: const TextStyle(
                                      color: ColorManger.green, // 👈 keep admin green
                                      fontWeight: FontWeight.bold,
                                      fontSize: 14,
                                    ),
                                  ),
