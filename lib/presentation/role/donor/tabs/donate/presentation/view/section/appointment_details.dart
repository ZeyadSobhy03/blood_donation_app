...
import 'package:blood_donation_app/presentation/role/donor/tabs/donate/presentation/view/section/qr_code_card.dart';
...
import 'appointment_information_card.dart';
...
class _AppointmentDetailsState extends State<AppointmentDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final location = appointment.hospitalId?.address ?? '';
