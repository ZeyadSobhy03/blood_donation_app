...
import 'package:blood_donation_app/presentation/role/admin/tabs/users/presentation/view/widgets/user_detail_dialog.dart';
      ...
      child: Row(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                CustomText(
                  ...
                  overflow: TextOverflow.ellipsis,
                  text:
                  '$roleLabel${bloodType.isNotEmpty ? ' . $bloodType' : ''} . ${isActive ? appLocalizations.active : appLocalizations.inactive}',
                  textStyle: TextStyle(
          ...
          Container(
            ...
            child: CustomText(
              text: isActive ? appLocalizations.active : appLocalizations.inactive,
              textStyle: TextStyle(
